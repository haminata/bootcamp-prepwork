 ...
 */
  ...
  function isGreaterThanFour(num) {
    return num > 5;
  }

  const moreThanFour = numbers.findIndex(isGreaterThanFour); 
 ...
 */
 ...
 function isGreaterThanSeven (num) {
    return num > 7;
  }
  const moreThanSevenIndex = numbers.findIndex(isGreaterThanSeven);
